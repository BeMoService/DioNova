    ...
    <>
      <section className="grid grid-2">
        ...
        <div className="col-text">
          ...
          <p>
            DJ Dio Nova draait sets vol energie, verrassingen en sfeer. 
            Met een mix van house, techno en urban weet ze elke zaal in beweging te krijgen. 
          ...
          <p style={{ marginTop:16 }}>
            ...
            haar sets zijn een beleving op zich. 
